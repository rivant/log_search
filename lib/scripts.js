...
module.exports = {
   ...
   searchRemote: function(params, callBack){
      remote = spawn('shell/remote_access.sh',
         [params.UserId, params.Server, params.Password, params.Source,
          params.Pattern, this.range.end, this.range.start, params.Dest]);
